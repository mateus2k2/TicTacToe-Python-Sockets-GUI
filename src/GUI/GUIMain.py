...
#------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def createGameButtons(self):
        ...
        self.NickEntry = Entry(self.createGameCanvas, font=("Impact", 30), width=20)
    ...
    def waitingRoomGUI(self, ID):
        ...
        self.waitingRoom = self.createCanvas(self.waitingRoomPageFrame)
        self.waitingRoom.create_image(0, 0, image=self.image, anchor=NW)
        self.waitingRoom.create_text(450, 100, text="Sala de Esperda: ", font=("Impact", 80), fill = "white")
        self.waitingRoom.create_text(450, 350, text= "ID: " + str(ID), font=("Impact", 40), fill = "white")
        self.waitingRoom.create_text(450, 450, text= "Esperando Outro Jogador", font=("Impact", 40), fill = "white")
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def joinGameButtons(self):
        ...
        self.NickEntry = Entry(self.joinGameCanvas, font=("Impact", 30), width=20)
    ...
    def sendIDGUI(self): 
        ...
        self.backButton = Button(self.SendIDCanvas, text="Voltar", font=("Impact", 30), command=lambda: self.backToMenu(self.SendIDPageFrame))
        self.SendIDCanvas.create_window(450, 500, window=self.backButton)
